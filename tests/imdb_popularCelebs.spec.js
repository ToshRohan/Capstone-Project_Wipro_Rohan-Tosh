...
//7
test('Christopher Nolan known for', async ({ page }) => {
...
//8
test('more to explore', async ({ page }) => {
...
//   await expect(page.locator('body')).toContainText('Taylor Swift & Travis Kelce');

//   })
// ).toBeVisible();

  await expect(page.locator('#news-card-section')).toBeVisible();
});
