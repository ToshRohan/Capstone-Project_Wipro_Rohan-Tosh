...
//   test('Movie posters are visible', async ({ page }) => {
...
//   test('Ranking order starts from 1', async ({ page }) => {
//     const firstMovie = await page.locator('h3').first().textContent();
//     expect(firstMovie).toContain('1.');
//   });
